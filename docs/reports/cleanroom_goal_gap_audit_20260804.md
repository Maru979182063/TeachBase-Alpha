...
Status: `pass_with_known_gap`
Terror index estimate: `3.0_to_3.2`
Completion claim allowed: `false`

## Checks

- `pass` `foundation_gate_sealed`
- `pass` `precleanup_gate_sealed`
- `pass` `final_chain_ops_gate_sealed`
- `pass` `four_final_chains_accounted_for`
- `pass` `scheduler_recovery_and_replacement_contract_present`
- `pass` `external_orchestrator_handshake_validated`
- `pass` `environment_interaction_isolated`
