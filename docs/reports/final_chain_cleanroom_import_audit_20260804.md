...
- chains: `4`
- required rows: `8`
- missing in cleanroom: `7`
- rows with source candidates: `7`

## Rows

- `doc_math` `canonical_entrypoint` `tools/docx_math_pipeline_final_orchestrator_v01.py`: `candidate_available_for_reviewed_import`, candidates: `old_local`
- `doc_math` `canonical_config_1` `config/docx_math_pipeline_final_v01.yaml`: `candidate_available_for_reviewed_import`, candidates: `old_local`
- `doc_math` `canonical_config_2` `config/docx_math_pipeline_final_active_manifest.json`: `candidate_available_for_reviewed_import`, candidates: `old_local`
