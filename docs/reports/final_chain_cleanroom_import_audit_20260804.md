...
- `doc_english` `canonical_entrypoint` `tools/english_docx_native_md_v01.py`: `already_present_in_cleanroom`, candidates: `old_local`
- `doc_english` `canonical_config_1` `config/english_docx_native_md/active_manifest.json`: `already_present_in_cleanroom`, candidates: `old_local`
- `doc_english` `canonical_config_2` `config/english_docx_native_md/group_repair_gate_v01.json`: `already_present_in_cleanroom`, candidates: `old_local`
