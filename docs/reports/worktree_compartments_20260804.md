...
- `??` `final_chain_registry` `docs/reports/final_chain_batch_queue_20260804.json`: protected-chain inventory, classifier, or cleanup candidate audit
- `??` `final_chain_registry` `docs/reports/final_chain_batch_queue_20260804.md`: protected-chain inventory, classifier, or cleanup candidate audit
- `??` `final_chain_registry` `tools/build_final_chain_batch_queue_report.py`: protected-chain inventory, classifier, or cleanup candidate audit
