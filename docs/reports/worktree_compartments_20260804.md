...
- `??` `final_chain_registry` `docs/reports/cleanroom_hardening_status_20260804.json`: protected-chain inventory, classifier, or cleanup candidate audit
- `??` `final_chain_registry` `docs/reports/cleanroom_hardening_status_20260804.md`: protected-chain inventory, classifier, or cleanup candidate audit
- `??` `final_chain_registry` `tools/run_cleanroom_hardening_status_gate.py`: protected-chain inventory, classifier, or cleanup candidate audit
