...
- `needs_cleanroom_import`: 2
- `needs_sample_input`: 1
...
- `doc_math` `needs_cleanroom_import` `cleanroom_import_required`; blockers: `canonical_configs_present`, `canonical_entrypoint_present`, `input_path_present`, `required_paths_present`; actions: `import_or_restore_canonical_entrypoint_and_configs`
