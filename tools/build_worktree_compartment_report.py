...
FINAL_CHAIN_PATHS = {
    ...
    "docs/reports/final_chain_control_contract_20260804.json",
    "docs/reports/final_chain_control_contract_20260804.md",
    "docs/reports/final_chain_environment_contract_20260804.json",
    "docs/reports/final_chain_environment_contract_20260804.md",
    ...
    "docs/reports/final_chain_batch_queue_20260804.json",
    "docs/reports/final_chain_batch_queue_20260804.md",
    "docs/reports/final_chain_batch_queue_validation_20260804.json",
    "docs/reports/final_chain_batch_queue_validation_20260804.md",
    "docs/reports/final_chain_orchestrator_handshake_20260804.json",
    "docs/reports/final_chain_orchestrator_handshake_20260804.md",
    "docs/reports/final_chain_orchestrator_handshake_validation_20260804.json",
    ...
    "docs/reports/pdf_english_raw_pdf_promotion_20260806.md",
    ...
    "docs/reports/pdf_english_recovery_intake_validation_20260804.md",
    "docs/reports/pdf_english_rebuild_decision_20260804.json",
    "docs/reports/pdf_english_rebuild_decision_20260804.md",
    "docs/reports/cleanroom_hardening_status_20260804.json",
    "docs/reports/cleanroom_hardening_status_20260804.md",
    "docs/reports/cleanroom_hardening_manifest_20260804.json",
    "docs/reports/cleanroom_hardening_manifest_20260804.md",
    "docs/reports/cleanroom_hardening_manifest_validation_20260804.json",
    "docs/reports/cleanroom_hardening_manifest_validation_20260804.md",
    "docs/reports/cleanroom_goal_gap_audit_20260804.json",
    "docs/reports/cleanroom_goal_gap_audit_20260804.md",
    ...
    "tests/test_cleanroom_goal_gap_audit.py",
    ...
    "tools/build_final_chain_control_contract.py",
    "tools/build_final_chain_environment_contract.py",
    ...
    "tools/build_final_chain_batch_queue_report.py",
    ...
    "tools/build_final_chain_execution_gap_report.py",
    ...
    "tools/build_pdf_english_raw_pdf_promotion_gate.py",
    ...
    "src/teachbase/final_chains/control_contract.py",
    "src/teachbase/final_chains/dashboard.py",
    "src/teachbase/final_chains/environment.py",
    "src/teachbase/final_chains/execution.py",
    ...
    "tests/fixtures/final_chain_samples/pdf_english_sample.pdf",
}
...
MIXED_PATHS = {
    "package.json": [
        ...
        "pdf_english_rebuild_decision audit npm script",
        "pdf_english_rebuild_smoke audit npm script",
...
def is_pdf_english_graph_first_config(path: str) -> bool:
    return path == "config/english_text_first_graph_first/" or path.startswith("config/english_text_first_graph_first/")
...
def classify(path: str) -> tuple[str, list[str]]:
    ...
    if is_pdf_english_graph_first_config(path):
        return "final_chain_registry", ["PDF English graph-first manifest and smoke evidence"]
