...
REVIEW_FLAGS = [
    ...
    "inline_figure_refine_panel_skip",
    ...
    "long_image_prepass_attempted",
    "long_image_branch",
    "long_image_segment_precut",
    "long_image_regroup",
    "tile_fallback",
    "panel_kept",
    "panel_subfigure_union",
    "cv_panel_component",
    ...
    "mineru_fallback_failed",
    "mineru_fallback_no_images",
    "mineru_option_key_from_nearest_text",
    "mineru_option_key_inferred_by_order",
    "figure_detection_zero_assets_recovered",
    "external_asset_copied",
    ...
    "final_asset_quality_panel_group_skip",
